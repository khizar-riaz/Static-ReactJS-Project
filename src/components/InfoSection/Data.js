...
export const homeObjOne = {
    ...
    lightText: true,
    lightTextDesc: true,
    topLine: 'Premium Khiz',
    headline: 'Unlimited Khiz with zero fees',
    description: 'Get access to our exclusive app that allows you to virtually interact with a real Khiz.',
